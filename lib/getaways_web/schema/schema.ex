defmodule GetawaysWeb.Schema.Schema do
  ...
  mutation do
    ...
    field :create_review, :booking do
      arg(:place_id, non_null(:id))
  ...
  subscription do
    @desc "Subscribe to booking change or a place"
    field :booking_change, :booking do
      ...
      trigger([:create_booking, :cancel_booking],
        topic: fn
          %Getaways.Vacation.Booking{} = booking -> [booking.place_id]
          _ -> []
        end
      )
    end
  ...
  input_object :place_filter do
    ...
    field(:wifi, :boolean)
    field(:available_dates, :date_range)
  end
  ...
  object :place do
    ...
    field :price_per_nigt, non_null(:decimal)
  ...
  #     arg :order, type: :sort_order, default_value: :asc
  #     arg :filter, :place_filter
  #     resolve &Resolvers.Vacation.places/
  #   end
